    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="bg-neutral-900/90 dark:bg-neutral-800/90 backdrop-blur-sm text-white px-6 py-2 rounded-full shadow-lg border border-neutral-700/50 flex items-center gap-8 text-xs font-medium justify-center">
                        {shortcuts.map(s => (
                            <div key={s.label} className="flex items-center gap-2">
                                <kbd className="bg-neutral-700 px-1.5 py-0.5 rounded text-[10px] font-mono text-neutral-200">
                                    {s.key}
                                </kbd>
